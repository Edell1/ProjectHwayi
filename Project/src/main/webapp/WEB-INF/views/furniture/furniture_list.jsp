	...
	<div class="furniture_list">
		...
		<div class="filter_box">
			...
			<div class="filter_brand">
				...
				<div class="filter_list">
					<div>
						<input type="checkbox" id="brand_box bb1" /> <label for="bb1">선정가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb2" /> <label for="bb2">찬흠가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb3" /> <label for="bb3">예림가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb4" /> <label for="bb4">영민가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb5" /> <label for="bb5">행복가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb6" /> <label for="bb6">종로가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb7" /> <label for="bb7">솔가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb8" /> <label for="bb8">데스크가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb9" /> <label for="bb9">좋은가구</label>
					</div>
					<div>
						<input type="checkbox" id="brand_box bb10" /> <label for="bb10">멋진가구</label>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="furni_box">
			<c:forEach var='obj' items="${checkedfurniturelist}">
				<div class="furni_cont cont1">
					<a href="${root }furniture/furniture_detail?furnitureid=${obj.furnitureid}">
						<div class="furni_img">
