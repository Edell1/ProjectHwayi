         ...
         <div class="filter_box">
            <div class="filter_color">
               ...
               <div class="filter_list">
                  <div>
                     <input type="radio" name="color" class="color_box cb1" id="cb1" value="화이트" /> 
                            <label for="cb1"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb2" id="cb2" value="그레이" /> 
                            <label for="cb2"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb3" id="cb3" value="블랙" /> 
                            <label for="cb3"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb4" id="cb4" value="베이지" /> 
                            <label for="cb4"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb5" id="cb5" value="브라운" /> 
                            <label for="cb5"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb6" id="cb6" value="실버" /> 
                            <label for="cb6"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb7" id="cb7" value="골드" /> 
                            <label for="cb7"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb8" id="cb8" value="레드" /> 
                            <label for="cb8"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb9" id="cb9" value="옐로우" /> 
                            <label for="cb9"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb10" id="cb10" value="그린" /> 
                            <label for="cb10"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb11" id="cb11" value="오렌지" /> 
                            <label for="cb11"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb12" id="cb12" value="블루" /> 
                            <label for="cb12"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb13" id="cb13" value="네이비" /> 
                            <label for="cb13"></label>
                  </div>
                  <div>
                     <input type="radio" name="color" class="color_box cb15" id="cb15" value="기타" /> 
            ...
            <div class="filter_brand">
               ...
               <div class="filter_list">
                  <div>
                     <input type="radio" name="brand" id="br1" value="Se001" /> 
                            <label for="br1">찬흠가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br2" value="Se002" /> 
                            <label for="br2">영민가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br3" value="Se003" /> 
                            <label for="br3">예림가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br4" value="Se004" /> 
                            <label for="br4">선정가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br5" value="Se005" /> 
                            <label for="br5">짱구가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br6" value="Se006" /> 
                            <label for="br6">철수가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br7" value="Se007" /> 
                            <label for="br7">유라가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br8" value="Se008" /> 
                            <label for="br8">훈이가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br9" value="Se009" /> 
                            <label for="br9">맹구가구</label>
                  </div>
                  <div>
                     <input type="radio" name="brand" id="br10" value="Se010" /> 
                            <label for="10">수지가구</label>
                  </div>
               </div>
            </div>
            <!-- 가로, 세로, 높이 입력창 -->
            <div class="filter_dimensions">
               ...
               <div class="dimension_list">
                  ...
                  <div>
                     <label for="length">세로: </label> <input type="number" name="length"
                        id="length" placeholder="단위:cm" />
                  </div>
                  <div>
      ...
      <div class="furni_box">
         <c:forEach var='obj' items="${checkedfurniturelist}">
            <div class="furni_cont cont1">
               <a href="">
                  <div class="furni_img">
                     <a href="${root }furniture/furniture_list?furnitureType=pa"><img
                        src="${root}image/furniture1/${obj.furniture_img1}.png" alt="" />
                  </div>
                  <div class="desc">
                     <p>${obj.brand}</p>
