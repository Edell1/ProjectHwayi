					...
					<table class="result_table btn_table">
						<tr>
							<c:choose>
								<c:when test="${not empty userId}">
									<td>
										<form action="login_buyer" method="get">
								...
								<c:otherwise>
									<td><a href="join_buyer" class="btn btn-primary">회원가입</a></td>
									<td><a href="login_buyer" class="btn btn-primary">로그인</a></td>
								</c:otherwise>
							</c:choose>
						</tr>
					</table>
