            ...
            <div class="join_cont">
               <div class="cont_box">
                  <form:form action="${root}user/join_pro1" method="post"
                     ...
                     <div class="form-group">
                        <form:label class="label_txt" path="gender">성별</form:label>
                        <form:select path="gender" id="category">
                           <form:option value="male" label="남성" />
                           <form:option value="female" label="여성" />
                        </form:select>
                        <%-- <form:errors class="err_txt" path='gender' style='color:red' /> --%>
                     </div>
                     <div class="form-group">
                        <form:label class="label_txt" path="age">나이</form:label>
                        <form:input path="age" class='form-control' placeholder='나이' />
                        <%-- <form:errors class="err_txt" path='age' style='color:red' /> --%>
                     </div>
