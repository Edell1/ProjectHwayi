...
function decreaseQuantity(button) {
    var quantityElement = button.parentElement.querySelector('.cartQuantity');
    var quantity = parseInt(quantityElement.innerHTML);
    var furnitureid = button.parentElement.querySelector('.item-checkbox').value; 
								...
								<c:forEach var="cartItem" items="${cartItems}">
									<div class="cart-item">
										<input type="checkbox" class="item-checkbox"
											...
											onclick="handleCheckboxChange(this)"> <img
					...
					<div class="cart_price1">
						<div class="cart_price2">
							<div class="cart_price3">
								<span class="">상품금액</span><span class=""><span class=""
									id="totalPrice">원</span></span>
							</div>
							<div class="cart_price3">
								<span class=" ">상품할인금액</span><span class=" ">0<span
									class=" ">원</span></span>
							</div>
							<div class="cart_price3">
							...
							<div class="cart_price3_font2">
								<span class=" ">결제예정금액</span> <span class="" id="finalPrice">
									<strong class=" ">${totalPrice}</strong> <span class=" ">${totalPrice}원</span>
								</span>
							</div>
						</div>
						<div class="btnBox">
							<a href="#" class="cartBtn delete_btn" onclick="deleteAllItems()">전체 삭제</a>
							<a class="cartBtn order_btn" type="button" onclick="getProductId()">주문하기</a>
						</div>
